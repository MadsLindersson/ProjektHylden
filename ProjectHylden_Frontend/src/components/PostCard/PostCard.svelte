...
<button onclick={() => onSelect(postItem)} class="bg-[#1A1715] rounded-lg overflow-hidden shadow-xl hover:shadow-2xl transition duration-300 cursor-pointer">
    ...
    <div class="flex justify-between items-center p-3">
        ...
        <Link to="/profile/{postItem.user_id}" class="flex items-center space-x-2">
            <img 
                ...
                alt=""
            /> 
            <span class="text-sm font-medium text-gray-300">{postItem.username}</span>
        </Link>
