...
<div 
    ...
    tabindex="-1"
>
    <section class="bg-[#1C1715] w-full max-w-5xl rounded-2xl overflow-hidden shadow-2xl flex flex-col md:flex-row border border-white/5">
        
<section class="flex-1 bg-[#141110] flex flex-col p-4 overflow-y-auto relative h-[300px] md:h-auto md:max-h-[600px]">
    ...
    {#if selectedIndex !== null}
        ...
        >
            ...
            <div class="absolute bottom-6 text-gray-500 text-sm font-medium">
    ...
    {/if}
        ...
        <div class="w-full md:w-[380px] flex flex-col bg-[#1C1715]">
            
            <header class="p-5 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <img 
                        src={`${API_URL}${post.profile_pic_url}`}
                        onerror={handleProfileImageError} alt="User Avatar" class="w-10 h-10 rounded-full border border-white/10" />
            ...
            <div class="px-5 flex-1">
                <div class="border border-white/20 rounded-2xl p-5 mb-4">
                    ...
                    <footer class="flex items-center gap-4 text-xs font-medium">
                        <span class="bg-[#332A26] text-white px-4 py-1.5 rounded-full border border-white/5">
                            {post.category_name}
                        </span>
