            ...
            <div class="flex items-center space-x-6">
                ...
                {#if $authStore.isAuthenticated}
                    <button
                        ...
                        class="text-gray-300 hover:text-white transition duration-150 cursor-pointer"
                    >
                        Sign out
                    </button>
                    ...
                    <Link
                        ...
                        class="inline-block transition duration-200 ease-in-out hover:scale-110 hover:opacity-80"
                    >
