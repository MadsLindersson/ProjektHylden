<script>
    ...
    import { userUpdated, userDeleted, somethingWentWrong } from "../../utilFrontend/toastr.js";
    ...
    let filteredUsers = $derived(
        users.filter((user) => {
            const matchesSearch =
                user.username.toLowerCase().includes(searchQuery.toLowerCase()) || user.role?.toLowerCase().includes(searchQuery.toLowerCase());
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-2">
                                <span class="text-[10px] uppercase font-black px-2 py-0.5 rounded bg-orange-500/10 text-orange-500 tracking-widest">
                                    {user.role}
                                </span>
